...
namespace WumpusAgentGame
{
    public partial class Settings : Form
    {
        ...
        public bool qLearning = false; // dmc
        public int qLearningTrials = -1;  // dmc
        ...
        private void btnPlay_Click(object sender, EventArgs e)
        {
            ...
            if (qLearning) DefaultQLearningTrials();  // added DMC
        ...
        private void chkQLearning_CheckedChanged(object sender, EventArgs e)
        {
             if (chkQLearning.Checked){
                lblLearningTrials.Visible = true;
                txtLearningTrials.Visible = true;
                chkAutoPlay.Checked = true;
                qLearning = true;  
             }
            else  // no Q learning
            {
                lblLearningTrials.Visible = false;
                txtLearningTrials.Visible = false;
                qLearning = false;   
             }
        }

        // default Q learning trials  
        void DefaultQLearningTrials()
        {
            try
            {
                qLearningTrials = Convert.ToInt32(txtLearningTrials.Text);
            }
            catch
            {
                qLearningTrials = 50;
