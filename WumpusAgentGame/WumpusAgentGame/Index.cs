...
namespace WumpusAgentGame
{
    ...
    public class Index : Microsoft.Xna.Framework.Game  
    {
        ...
        Game _Wumpus;
        Settings _settings;
        bool userCancelled; // enhanced ability to exit gracefully - DMC
        ...
        {
            // Allows the game to exit - added userCancelled - DMC
            if (userCancelled || GamePad.GetState(PlayerIndex.One).Buttons.Back == ButtonState.Pressed)
            {
                this.Exit();
                return;  // added DMC
            }
